...
export const adminApi = {
  ...
  grammarQuestions: (topicId) =>
    api.get('/api/admin/grammar/questions', { params: { topicId } }).then((r) => r.data),
  createGrammarQuestion: (d) => api.post('/api/admin/grammar/questions', d).then((r) => r.data),
  deleteGrammarQuestion: (id) =>
    api.delete(`/api/admin/grammar/questions/${id}`).then((r) => r.data),
  ...
  examQuestions: (setId) =>
    api.get(`/api/admin/exams/sets/${setId}/questions`).then((r) => r.data),
  ...
  /* Exam papers — full lifecycle */
  examPapers: () => api.get('/api/admin/exam-papers').then((r) => r.data),
  createExamPaper: (d) => api.post('/api/admin/exam-papers', d).then((r) => r.data),
  updateExamPaper: (id, d) => api.patch(`/api/admin/exam-papers/${id}`, d).then((r) => r.data),
  deleteExamPaper: (id) => api.delete(`/api/admin/exam-papers/${id}`).then((r) => r.data),
  launchExamPaper: (id, scheduledAt) =>
    api.patch(`/api/admin/exam-papers/${id}/launch`, { scheduledAt }).then((r) => r.data),
  endExamPaper: (id) => api.patch(`/api/admin/exam-papers/${id}/end`).then((r) => r.data),
  examPaperAttempts: (id) =>
    api.get(`/api/admin/exam-papers/${id}/attempts`).then((r) => r.data),
  createExamPaperSection: (d) =>
    api.post(`/api/admin/exam-papers/${d.paperId}/sections`, d).then((r) => r.data),
  createExamPaperQuestion: (d) =>
    api.post(`/api/admin/exam-papers/${d.paperId}/sections/${d.sectionId}/questions`, d).then((r) => r.data),
  ...
  deleteSpeakingPrompt: (id) =>
    api.delete(`/api/admin/speaking/prompts/${id}`).then((r) => r.data),

  threads: () => api.get('/api/admin/community/threads').then((r) => r.data),
  updateThread: (id, d) =>
    api.patch(`/api/admin/community/threads/${id}`, d).then((r) => r.data),
  ...
  deleteFeatureFlag: (id) =>
    api.delete(`/api/admin/feature-flags/${id}`).then((r) => r.data),

  auditLog: (p) => api.get('/api/admin/audit-log', { params: p }).then((r) => r.data),
  auditHint: (action) =>
    api.post('/api/admin/audit/hint', { action }).then((r) => r.data).catch(() => null),
};
